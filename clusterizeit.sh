...
OPTS=$(getopt -a --long help --l name: --l version: -l token: -l computes: -l drives: -l frontends: -l compute-memory: -l data-drives: -l parity-drives: -l baseport: -l management-nic: "n" "$@")
...
#echo "wait 5 minutes for containers to come up"
#wait 300
#weka debug config override clusterInfo.singleHopWriteEnabled true
#pdsh sudo mkdir /mnt/weka
#pdsh sudo mount -t wekafs default /mnt/weka
